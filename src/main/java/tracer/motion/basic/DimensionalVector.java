...
public class DimensionalVector implements Comparable<DimensionalVector> {
    ...
    public DimensionalVector add(DimensionalVector vector) {
        vector = vector.convertToSameUnit(this);
        DimensionalVector tmp = convertToSameUnit(vector);
    ...
    private DimensionalVector convertToSameUnit(DimensionalVector vector) {
